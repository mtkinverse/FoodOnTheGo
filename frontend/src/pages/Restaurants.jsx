...
const Restaurants = () => {
  ...
  {loggedIn && Array.isArray(orderAgain) && orderAgain.length > 0 && (
    <div className="mb-12 bg-white rounded-xl shadow-md p-6  w-[90vw] max-w-7xl min-h-[400px]">
      <div className="flex items-center justify-center py-6 space-x-3">
        <Repeat className="text-purple-600" size={24} />
        <h2 className="text-3xl font-extrabold text-purple-800">Order Again</h2>
      </div>
  ...
  <div className="bg-white rounded-xl shadow-md p-6 w-[90vw] max-w-7xl min-h-[400px]">
    <div className="py-2">
      <div className="flex items-center justify-center py-6 space-x-3">
        <Store className="text-purple-600" size={34} />
        <h1 className="text-3xl font-extrabold text-purple-800">All Restaurants</h1>
      </div>
