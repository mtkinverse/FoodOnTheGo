        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 p-8 lg:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white opacity-70" size={18} />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-10 pr-10 py-3 rounded-lg bg-white bg-opacity-20 border border-white border-opacity-30 text-white placeholder-white placeholder-opacity-70 focus:ring-2 focus:ring-white focus:border-transparent transition duration-200"
                    placeholder="Enter your password"
                  />
                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white opacity-70" size={18} />
                  <button
                    type="button"
            ...
            <p className="mt-8 text-center text-sm text-white text-opacity-80">
              ...
              <a href="/register" className="font-medium text-white hover:text-opacity-90 underline">
                Sign up
              </a>
            </p>
          </div>
          ...
          <div className="hidden md:block w-1/2 bg-cover bg-center relative overflow-hidden"
            ...
            <div className="relative h-full flex items-center">
              <div className="px-12 py-8">
                ...
                <p className="text-lg text-white opacity-90">Log in to explore our delicious menu and exclusive offers.</p>
              </div>
            </div>
          </div>
        </div>
