...
const {addMenu,addMenuItem,getOwnedRestaurants,AddRestaurant,deleteMenu,updateTimings,ChangeImage, addLocation, getLocations, deleteItem, updateItem} = require('../controllers/ownerController');
