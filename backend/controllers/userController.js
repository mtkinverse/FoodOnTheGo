...
module.exports.registerUser = (req, res) => {
    ...
    db.query(q, [req.body.email], (err, data) => {
        ...
        const qInsert = "INSERT INTO Customers (first_name,last_name,phoneNo,email,password) VALUES (?, ?, ?, ?, ?)";
        const values = [req.body.firstname,req.body.lastname,req.body.phoneNo,req.body.email, hash];
...
module.exports.loginUser = (req, res) => {
    ...
    db.query(q, [req.body.email], (err, data) => {
        ...
        const token = jwt.sign({id: user.user_id},"mykey")
